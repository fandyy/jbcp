...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<p>Below you can find some highlights about myCalendar. Each chapter will have a slightly different summary depending on what will be done.</p>\n");
      out.write("<ul>\n");
      out.write("    <li><a id=\"eventsLink\" href=\"events/\">All Events</a> - shows all events for all users. Once secured, this will only be viewable by administrators.</li>\n");
      out.write("    <li><a id=\"myEventsLink\" href=\"events/my\">My Events</a> - shows all events that user1@example.com is the owner or attendee. Once we apply security only a logged in user\n");
      out.write("        will be able to view this page. Additionally, the logged in user will be used rather than always using user1@example.com</li>\n");
      out.write("    <li><a id=\"createEventLink\" href=\"events/form\">Create Event</a> - will allow creating a new Event with user1@example.com as the owner. Once we add security, only a logged in\n");
      out.write("        user will be able to view this page. Additionally, the logged in user will be the owner rather than always using user1@example.com.</li>\n");
      out.write("    <li>\n");
